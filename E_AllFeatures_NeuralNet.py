...
class personalCallback(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if saveModel:
            modelSavepath = Path(f'models/{self.tStamp}_Acc-{acc:.4f}_Epoch-{epoch+1:03d}-NeuralNet.h5')
...
if __name__ == '__main__':
    ...
    opt = optimizers.Adam(lr=LR_AT_EPOCH0, decay=0.0 ,beta_1=0.88, beta_2=0.9985, epsilon=1e-8, amsgrad=False)
    ...
    logDir = Path(f'logdir/{pCallBack.tStamp}_relu_HLs-2_NEUs-2048_L1L2-0.00001')
